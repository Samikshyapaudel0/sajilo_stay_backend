...
//         console.log(propertyData.error.issues);
//         console.log("Received Body:");
//         console.log(req.body);

//         return ApiResponseHelper.error(res, propertyData.error.issues, 400);
//       }
...
export class HostPropertyController {
  async createProperty(req: Request, res: Response) {
    ...
    try {
      ...
      // Convert uploaded files to image filename array
    ...
    try {
      ...
      if (property.hostId.toString() !== hostId.toString()) {
        throw new HttpException(
          403,
          "Forbidden - Property does not belong to this host",
        );
      }
